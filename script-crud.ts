...
const atualizarUI = () => {
    ...
    const btnSalvarEdicao: HTMLButtonElement = document.querySelector('.app__form-footer__button--confirm') as HTMLButtonElement;
    ...
    if(!btnAdicionarTarefa) {
        throw Error('Desculpe, o elemento "btnAdicionarTarefa" não foi encontrado.');
    }
    ...
    estadoInicial.tarefas.forEach(tarefa => {
        ...
        //     estadoInicial = editarTarefa(, tarefa);
        //     atualizarUI();
        // }

        // btnSalvarEdicao!.onsubmit = (evento) => {
        //     evento.preventDefault();
